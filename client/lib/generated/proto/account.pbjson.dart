...
final $typed_data.Uint8List authStateDescriptor = $convert.base64Decode(
    'CglBdXRoU3RhdGUSEwoPVU5BVVRIRU5USUNBVEVEEAASEQoNQVVUSEVOVElDQVRFRBAB');
...
final $typed_data.Uint8List accountDescriptor = $convert.base64Decode(
    'CgdBY2NvdW50Eg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEh0KCmF2YXRhcl91cmwYAyABKAlSCWF2YXRhclVybA==');
...
final $typed_data.Uint8List createAccountRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVBY2NvdW50UmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEh0KCmF2YXRhcl91cmwYAyABKAlSCWF2YXRhclVybA==');
...
final $typed_data.Uint8List createAccountResponseDescriptor = $convert.base64Decode(
    'ChVDcmVhdGVBY2NvdW50UmVzcG9uc2USFAoFdG9rZW4YASABKAlSBXRva2VuEiIKB2FjY291bnQYAiABKAsyCC5BY2NvdW50UgdhY2NvdW50');
...
final $typed_data.Uint8List findUserDescriptor =
    $convert.base64Decode('CghGaW5kVXNlchIOCgJpZBgBIAEoCVICaWQ=');
...
final $typed_data.Uint8List findMeResponseDescriptor = $convert.base64Decode(
    'Cg5GaW5kTWVSZXNwb25zZRInCgdhY2NvdW50GAEgASgLMgguQWNjb3VudEgAUgdhY2NvdW50iAEBEikKCmF1dGhfc3RhdGUYAiABKA4yCi5BdXRoU3RhdGVSCWF1dGhTdGF0ZUIKCghfYWNjb3VudA==');
