...
const Message$json = const {
  ...
  '2': const [
    ...
    const {'1': 'author', '3': 3, '4': 1, '5': 11, '6': '.Account', '10': 'author'},
    const {'1': 'timestamp', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'timestamp'},
  ],
};

/// Descriptor for `Message`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List messageDescriptor = $convert.base64Decode('CgdNZXNzYWdlEg4KAmlkGAEgASgDUgJpZBISCgR0ZXh0GAIgASgJUgR0ZXh0EiAKBmF1dGhvchgDIAEoCzIILkFjY291bnRSBmF1dGhvchI4Cgl0aW1lc3RhbXAYBCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgl0aW1lc3RhbXA=');
...
final $typed_data.Uint8List createMessageRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVNZXNzYWdlUmVxdWVzdBIXCgdyb29tX2lkGAEgASgDUgZyb29tSWQSEgoEdGV4dBgCIAEoCVIEdGV4dA==');
...
final $typed_data.Uint8List observeMessageRequestDescriptor = $convert.base64Decode('ChVPYnNlcnZlTWVzc2FnZVJlcXVlc3QSFwoHcm9vbV9pZBgBIAEoA1IGcm9vbUlk');
...
final $typed_data.Uint8List findAllMessagesRequestDescriptor = $convert.base64Decode('ChZGaW5kQWxsTWVzc2FnZXNSZXF1ZXN0EhcKB3Jvb21faWQYASABKANSBnJvb21JZA==');
...
final $typed_data.Uint8List messagesResponseDescriptor = $convert.base64Decode('ChBNZXNzYWdlc1Jlc3BvbnNlEiQKCG1lc3NhZ2VzGAEgAygLMgguTWVzc2FnZVIIbWVzc2FnZXM=');
