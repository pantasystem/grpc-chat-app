...
final $typed_data.Uint8List messageDescriptor = $convert.base64Decode('CgdNZXNzYWdlEg4KAmlkGAEgASgJUgJpZBISCgR0ZXh0GAIgASgJUgR0ZXh0EiAKBmF1dGhvchgDIAEoCzIILkFjY291bnRSBmF1dGhvchI4Cgl0aW1lc3RhbXAYBCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgl0aW1lc3RhbXA=');
...
final $typed_data.Uint8List createMessageRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVNZXNzYWdlUmVxdWVzdBIXCgdyb29tX2lkGAEgASgJUgZyb29tSWQSEgoEdGV4dBgCIAEoCVIEdGV4dA==');
...
final $typed_data.Uint8List observeMessageRequestDescriptor = $convert.base64Decode('ChVPYnNlcnZlTWVzc2FnZVJlcXVlc3QSFwoHcm9vbV9pZBgBIAEoCVIGcm9vbUlk');
...
final $typed_data.Uint8List findAllMessagesRequestDescriptor = $convert.base64Decode('ChZGaW5kQWxsTWVzc2FnZXNSZXF1ZXN0EhcKB3Jvb21faWQYASABKAlSBnJvb21JZA==');
