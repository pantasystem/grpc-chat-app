...
class ObserveMessageRequest extends $pb.GeneratedMessage {
  ...
  factory ObserveMessageRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ObserveMessageRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ObserveMessageRequest clone() =>
      ObserveMessageRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ObserveMessageRequest copyWith(
          void Function(ObserveMessageRequest) updates) =>
      super.copyWith((message) => updates(message as ObserveMessageRequest))
          as ObserveMessageRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ObserveMessageRequest create() => ObserveMessageRequest._();
  ObserveMessageRequest createEmptyInstance() => create();
  static $pb.PbList<ObserveMessageRequest> createRepeated() =>
      $pb.PbList<ObserveMessageRequest>();
  @$core.pragma('dart2js:noInline')
  static ObserveMessageRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ObserveMessageRequest>(create);
...
class FindAllMessagesRequest extends $pb.GeneratedMessage {
  ...
  factory FindAllMessagesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory FindAllMessagesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  FindAllMessagesRequest clone() =>
      FindAllMessagesRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  FindAllMessagesRequest copyWith(
          void Function(FindAllMessagesRequest) updates) =>
      super.copyWith((message) => updates(message as FindAllMessagesRequest))
          as FindAllMessagesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FindAllMessagesRequest create() => FindAllMessagesRequest._();
  FindAllMessagesRequest createEmptyInstance() => create();
  static $pb.PbList<FindAllMessagesRequest> createRepeated() =>
      $pb.PbList<FindAllMessagesRequest>();
  @$core.pragma('dart2js:noInline')
  static FindAllMessagesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FindAllMessagesRequest>(create);
